                ...
                <div id="navbar" class="collapse navbar-collapse pull-center">
                    <?php if($_SESSION['lang'] == 'lt') { ?>
                        <div class="nav navbar-nav">
                            ...
                            <div class="drop-menu"><a <?php if(strpos($uri, 'media') !== false) { echo 'class="active_bottom"'; } ?> href="kontaktai.php#muza"><?php echo $meniu->mediaLt; ?></a>
                                <div class="drop-list"><a <?php if(strpos($uri, 'meniu') !== false) { echo 'class="active_bottom"'; } ?> href="kontaktai.php#muza"><?php echo $meniu->subMenu1Lt; ?></a></div>
                                <div class="drop-list"><a <?php if(strpos($uri, 'meniu') !== false) { echo 'class="active_bottom"'; } ?> href="kontaktai.php#muza"><?php echo $meniu->subMenu2Lt; ?></a></div>
                                <div class="drop-list"><a <?php if(strpos($uri, 'meniu') !== false) { echo 'class="active_bottom"'; } ?> href="kontaktai.php#muza"><?php echo $meniu->subMenu3Lt; ?></a></div>
                            </div>
