            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul>
                        ...
                        <li><a <?php if(strpos($uri, 'archyvas') !== false) { echo 'class="active_bottom"'; } ?> href="archyvas.php#muza"><?php echo $meniu->archyvasLt; ?></a></li>
                    ...
                    <ul>
                        ...
                        <li><a <?php if(strpos($uri, 'archyvas') !== false) { echo 'class="active_bottom"'; } ?> href="archyvas.php#muza"><?php echo $meniu->archyvasEn; ?></a></li>
                    ...
                    <ul>
                        ...
                        <li><a <?php if(strpos($uri, 'archyvas') !== false) { echo 'class="active_bottom"'; } ?> href="archyvas.php#muza"><?php echo $meniu->archyvasFr; ?></a></li>
