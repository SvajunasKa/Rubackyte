                                ...
                                <section class="panel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="diskografija_redaguoti.php?redaguoti=<?php echo $value->id; ?>" class="btn btn-sm btn-success">Redaguoti</a> <a href="?istrinti=<?php echo $value->id; ?>" class="btn btn-sm btn-danger">Ištrinti</a></td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <textarea id="aprasymasEN" name="aprasymasEn" class="form-control" id="" cols="30" rows="10"></textarea>
                                                </div>
                                                <label class="col-lg-2 col-sm-2 control-label">Aprašymas FR</label>
                                                <div class="col-lg-10">
                                                    <textarea id="aprasymasFR" name="aprasymasFr" class="form-control" id="" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
                                ...
                                <section class="panel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="diskografija_redaguoti_dvd.php?redaguoti=<?php echo $value_dvd->id; ?>" class="btn btn-sm btn-success">Redaguoti</a> <a href="?istrinti_dvd=<?php echo $value_dvd->id; ?>" class="btn btn-sm btn-danger">Ištrinti</a></td>
                                        </tr>
                                        <?php } ?>
                                        </thead>
                                        <tbody>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 col-sm-2 control-label">Aprašymas LT</label>
                                                <div class="col-lg-10">
                                                    <textarea id="aprasymasLT" name="aprasymas_dvdLt" class="form-control" id="" cols="30" rows="10"></textarea>
                                                </div>
                                                <label class="col-lg-2 col-sm-2 control-label">Aprašymas EN</label>
                                                <div class="col-lg-10">
                                                    <textarea id="aprasymasEN" name="aprasymas_dvdEn" class="form-control" id="" cols="30" rows="10"></textarea>
                                                </div>
                                                <label class="col-lg-2 col-sm-2 control-label">Aprašymas FR</label>
                                                <div class="col-lg-10">
                                                    <textarea id="aprasymasFR" name="aprasymas_dvdFr" class="form-control" id="" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
