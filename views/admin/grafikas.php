...
<?php
    if(isset($_POST['grafikas_submit'])) {
        ...
        if($graf->save()) {
            $session->message(1);
            redirect('grafikas.php');
        }
    }

    if(isset($_GET['istrinti_repertuaras'])) {
        $graft = Repertuaras::find($_GET['istrinti_repertuaras']);
...
<!--                    nav-active-->
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="fa fa-file"></i> <span>Puslapiai </span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="grafikas.php"> Repertuarai</a></li>
        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
                <h3>
                    Puslapis - Repertuarai
                </h3>
                <span class="sub-title">Pagrindinis / Repertuarai</span>
            </div>
            <!-- page head end-->
                ...
                <section class="panel">
                    <header class="panel-heading tab-dark ">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#home2">Repertuarai</a>
                            </li>
                        </ul>
                    </header>
                               ...
                               <section class="panel">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <?php foreach($kategorijos as $kategorija) { ?>
                                                        <option value="<?php echo $kategorija->id; ?>"><?php echo $kategorija->kategorijaLt; ?></option>
                                                    <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="row" style="margin-top: 40px;">
                                    <div class="col-sm-12">
                                        ...
                                        <?php $koncertai = Repertuaras::all(); ?>
                                        <?php foreach($koncertai as $vals) { ?>
                                        <tr>
                                            <td><?php echo $vals->id; ?></td>
                                            <td><?php echo $vals->kompozitorius; ?></td>
                                            <td><?php echo $vals->pavadinimasLt; ?></td>
                                            <td><?php $gff = GrafikasKategorija::find($vals->kategorija); echo $gff->kategorijaLt; ?></td>
                                            <td><a href="repertuaras_redaguoti.php?redaguoti=<?php echo $vals->id; ?>" class="btn btn-sm btn-success">Redaguoti</a> <a href="?istrinti_repertuaras=<?php echo $vals->id; ?>" class="btn btn-sm btn-danger">Ištrinti</a></td>
                                        </tr>
                                        <?php } ?>
                                        </thead>
                                        <tbody>
