                        ...
                        <div class="tab-content">
                            ...
                            <div id="home-iso" class="tab-pane active">
                                ...
                                <header class="panel-heading">
                                    Redaguoti CD / Vinilą <a href="diskografija.php" class="btn btn-sm btn-info pull-right">Grįžti atgal</a>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="pavadinimasLt" class="form-control" value="<?php echo $cd_vinilas[0]->pavadinimasLt; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Pavadinimas EN</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="pavadinimasEn" class="form-control" value="<?php echo $cd_vinilas[0]->pavadinimasEn; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Pavadinimas FR</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="pavadinimasFr" class="form-control" value="<?php echo $cd_vinilas[0]->pavadinimasFr; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea id="aprasymasLT" name="aprasymasLt2" class="form-control" id="" cols="30" rows="10">
                                                    <?php echo $cd_vinilas[0]->aprasymasLt; ?>
                                                </textarea>
                                            </div>
                                            <label class="col-lg-2 col-sm-2 control-label">Aprašymas EN</label>
                                            <div class="col-lg-10">
                                                <textarea id="aprasymasEN" name="aprasymasEn2" class="form-control" id="" cols="30" rows="10">
                                                    <?php echo $cd_vinilas[0]->aprasymasEn; ?>
                                                </textarea>
                                            </div>
                                            <label class="col-lg-2 col-sm-2 control-label">Aprašymas FR</label>
                                            <div class="col-lg-10">
                                                <textarea id="aprasymasFR" name="aprasymasFr2" class="form-control" id="" cols="30" rows="10">
