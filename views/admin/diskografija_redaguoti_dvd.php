...
<?php
    if(isset($_POST['submit'])) {
        $cd = DiskografijaDvd::find($_GET['redaguoti']);
        $cd->pavadinimasLt = $_POST['pavadinimas_dvdLt'];
        $cd->pavadinimasEn = $_POST['pavadinimas_dvdEn'];
        $cd->pavadinimasFr = $_POST['pavadinimas_dvdFr'];
        if(!empty($_FILES['fileToUpload']["tmp_name"])) {
            $cd->nuotrauka = imageUpload($_FILES['fileToUpload'], 1);
        }
        $cd->aprasymasLt = $_POST['aprasymas_dvdLt2'];
        $cd->aprasymasEn = $_POST['aprasymas_dvdEn2'];
        $cd->aprasymasFr = $_POST['aprasymas_dvdFr2'];
        if($cd->save()) {
            $session->message(1);
            redirect('diskografija_redaguoti_dvd.php?redaguoti='.$_GET['redaguoti']);
        }
...
<!--                    nav-active-->
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="fa fa-file"></i> <span>Puslapiai </span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="diskografija.php"> Diskografija</a></li>
                ...
                <section class="panel">
                    <header class="panel-heading tab-dark ">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#home-iso">DVD</a>
                            </li>
                        </ul>
                    </header>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <?php $cd_vinilas = DiskografijaDvd::where('id', $_GET['redaguoti']); ?>
                            <div id="home-iso" class="tab-pane active">
                                <section class="panel">
                                <header class="panel-heading">
                                    Redaguoti DVD <a href="diskografija.php" class="btn btn-sm btn-info pull-right">Grįžti atgal</a>
                                </header>
                                <div class="panel-body">
                                    <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="pavadinimas_dvdLt" class="form-control" value="<?php echo $cd_vinilas[0]->pavadinimasLt; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Pavadinimas EN</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="pavadinimas_dvdEn" class="form-control" value="<?php echo $cd_vinilas[0]->pavadinimasEn; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Pavadinimas FR</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="pavadinimas_dvdFr" class="form-control" value="<?php echo $cd_vinilas[0]->pavadinimasFr; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea id="aprasymasLT" name="aprasymas_dvdLt2" class="form-control" id="" cols="30" rows="10">
                                                    <?php echo $cd_vinilas[0]->aprasymasLt; ?>
                                                </textarea>
                                            </div>
                                            <label class="col-lg-2 col-sm-2 control-label">Aprašymas EN</label>
                                            <div class="col-lg-10">
                                                <textarea id="aprasymasEN" name="aprasymas_dvdEn2" class="form-control" id="" cols="30" rows="10">
                                                    <?php echo $cd_vinilas[0]->aprasymasEn; ?>
                                                </textarea>
                                            </div>
                                            <label class="col-lg-2 col-sm-2 control-label">Aprašymas FR</label>
                                            <div class="col-lg-10">
                                                <textarea id="aprasymasFR" name="aprasymas_dvdFr2" class="form-control" id="" cols="30" rows="10">
...
<script type="text/javascript">
    $(document).ready(function() {  
        <?php if(!empty($session->message) && $session->message == 1) { ?>
            toastr.success("Sėkmingai atnaujintas", "DVD");
        <?php } ?>
    });
</script>
