...
?>
<?php
if (isset($_GET['istrinti_popup'])) {
    $koncertas = IntroPopUp::find($_GET['istrinti_popup']);

    if ($koncertas->delete()) {
        $session->message(6);
        redirect('introPopUp.php');
    }
}

if (isset($_POST['introPopUp'])) {
    $koncertas = new IntroPopUp();
    $koncertas->nuoroda = $_POST['nuoroda'];
                            ...
                            <section class="panel">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php foreach ($konc as $kon) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $kon->nuoroda; ?></td>
                                            <td>
                                                <img style="width: 100px; height: 50px"
                                                     src="/assets/images/<?php echo $kon->nuotrauka; ?>" alt=""/>

                                            </td>
                                            <td><a href="?istrinti_popup=<?php echo $kon->id; ?>"
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" name="introPopUp" value="Išsaugoti"
