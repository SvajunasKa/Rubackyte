        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-offset-1 col-sm-10">
                    <?php if($_SESSION['lang'] == 'lt' ) { echo $biografija->aprasymasLt; } ?>
                    <?php if($_SESSION['lang'] == 'en' ) { echo $biografija->aprasymasEn; } ?>
                    <?php if($_SESSION['lang'] == 'fr' ) { echo $biografija->aprasymasFr; } ?>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-offset-1 col-sm-10">
                    <div class="col-sm-6 padding-none jquery_1">
                        <?php if($_SESSION['lang'] == 'lt' ) { echo $biografija->aprasymasLt2; } ?>
                        <?php if($_SESSION['lang'] == 'en' ) { echo $biografija->aprasymasEn2; } ?>
                        <?php if($_SESSION['lang'] == 'fr' ) { echo $biografija->aprasymasFr2; } ?>
                        <!--  <p class="about_p"></p>-->
